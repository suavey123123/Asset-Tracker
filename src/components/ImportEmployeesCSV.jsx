...
const TEMPLATE = `name,email,title,department,phone,hire_date,asset_tag,asset_category,asset_model,asset_serial,purchase_date,provision_date,purchase_cost,cpu,gpu,ram,ssd,hdd,mac_wifi,mac_lan,os_version,resolution,size
          ...
          <>
            ...
            {preview.length > 0 && !errors.length && (
              <div style={{ border:'1px solid var(--border)', borderRadius:'var(--radius)' }}>
                ...
                <div style={{ overflow:'auto', maxHeight:220, borderRadius:'0 0 var(--radius) var(--radius)' }}>
