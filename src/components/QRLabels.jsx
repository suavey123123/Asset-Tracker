...
export default function QRLabels() {
  ...
  function printLabels() {
    ...
    const labelGrid = selectedAssets.map((a, i) => {
      ...
      return '<div class="label"><img src="' + qrUrl + '" width="70" height="70" /><div class="info"><div class="tag">' + a.asset_tag + '</div><div class="model">' + (a.model || a.category || '').substring(0, 28) + '</div>' + '</div></div>'
    }).join('')
